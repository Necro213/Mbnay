...
@include('partials.business.header')
    ...
    <main>
        ...
        <section class="well well1 well1_ins1">
            <div class="camera_container">
                <div id="camera" class="camera_wrap">
                    <div data-src="{{asset('img/business/page-1_slide1.jpg')}}">
                    ...
                    <div data-src="{{asset('img/business/page-1_slide2.jpg')}}">
                        <div class="camera_caption fadeIn">
                    ...
                    <div data-src="{{asset('img/business/page-1_slide3.jpg')}}">
                        <div class="camera_caption fadeIn">
                            <div class="jumbotron">
                                <em>
                                    SOLUTIONS
        ...
        <section class="well well3 parallax" data-url="{{asset('img/business/parallax1.jpg')}}" data-mobile="
      true" data-speed="0.9">
            <div class="container">
