                        ...
                        <div class="row">
                            <form class="form-horizontal" method="POST" action="{{ url('/AddPost') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                                    <label for="post_title" class="col-md-4 control-label">Titulo</label>
                                ...
                                <div class="form-group{{ $errors->has('post_image') ? ' has-error' : '' }}">
                                    <label for="post_image" class="col-md-4 control-label">Imagen de Post</label>
                                ...
                                <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                                    <label for="post_body" class="col-md-4 control-label">Cuerpo del post</label>
                                    <div class="col-md-6">
